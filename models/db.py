# -*- coding: utf-8 -*-
from gluon.tools import Auth, Service, Crud, PluginManager, Mail
...
# override all/any default auth settings, users can *only* auth against Active
# Directory
auth.settings.login_methods = [ldap_auth(mode='Domino',
                                       manage_user=False,
                                       user_firstname_attrib='givenName',
                                       user_lastname_attrib='sn',
                                       server='mmhtyinddc01.indochina.local',
                                    #    base_dn='ou=Users, dc=coca-cola, dc=com.mm',
                                       secure=False,
                                       db=db)]
